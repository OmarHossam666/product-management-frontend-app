...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      addToast(err?.data?.message || 'Login failed. Please check your credentials.', 'error');
    }
  };

  const handleSocialLogin = (provider) => {
    // Redirect to backend OAuth2 endpoint which will handle the flow
    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-sidebar">
        ...
        <div className="auth-brand">
          <h1>Aura</h1>
          <p>The enterprise product management solution designed for clarity, scale, and modern performance.</p>
        </div>
      </div>
